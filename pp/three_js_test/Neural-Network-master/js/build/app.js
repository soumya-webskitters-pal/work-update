...
// ---- Camera
camera = new THREE.PerspectiveCamera(45, screenRatio, 0.01, 3000);
...
window.addEventListener('keypress', function (event) {
	...
	switch (key) {
		...
		case 97:
			/*a*/
			sceneSettings.enableGridHelper = !sceneSettings.enableGridHelper;
			break;
		...
		case 115:
			/*s*/
			sceneSettings.enableAxisHelper = !sceneSettings.enableAxisHelper;
			break;
