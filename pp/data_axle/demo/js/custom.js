...
if (window.outerHeight <= 360) {
    document.body.classList.add("SafariView");
}

const desktop_anim_scroll = 1400, mob_anim_scroll = 3000;
...
//// intro anim scroll height //if window.innerHeight<300 vale willbe 300
let total_length = 700;


//for idle time
let idleInterval,
    idleTime = 0,
    idleTimeSet = 15; //5s buffer time--for loading
...
function pageAutoScroll() {
    let scrollLimit = total_length;
    //for desktop
    if (window.outerWidth > 768) {
        scrollLimit = desktop_anim_scroll;
    }
    //for mobile
    else {
        scrollLimit = mob_anim_scroll;
    }
    ...
    function after_init() {
        ...
        ScrollTrigger.matchMedia({
                ...
                if ($(".home_top_section").length) {
                    ...
                    if ($(".home_anim").length) {
                        ...
                        gsap.timeline()
                            ...
                            .from($(".home_type").children().not(".x"), 1, {
                                opacity: 0,
                                x: -50,
                                transformOrigin: "50% 50%",
                                stagger: 0.04,
                        ...
                        home_timeline
                            ...
                            .to(".home_patternx", 0.01, {
                                opacity: 1,
                            }, "-=0.751")
                            .to(".home_patternx", 0.65, {
                                scale: 0.55,
                            }, "-=0.75")
                            .to(".home_svg", 0.5, {
                                scale: 5,
            ...
            "(max-width: 767px)": function () {
                //change scroller value - scroll more
                total_length = 1500;
                ...
                if ($(".home_top_section").length) {
                    ...
                    if ($(".home_anim").length) {
                        ...
                        home_timeline
                            ...
                            .to(".line_draw,.home_small_dot,.home_text.x,.top_border", 0.01, {
                                opacity: 0,
                            }, "-=0.99")
                            .to(".home_type", 0.3, {
                                opacity: 0,
                            ...
                            .to(".home_anim", 0.05, {
                                opacity: 0,
                                onComplete: () => {
                                    $(".home_pattern_g").addClass("start");
                                    $(".home_tiles").addClass("start");
                                },
                            }, "-=0.01")
                            .to("#circle_clip2", 1, {
                                attr: { r: 500 },
                ...
                gsap.timeline()
                    .to(".big_x", 2, {
                        ...
                        onComplete: function () {
                            ...
                            ////idle time checking
                            idleInterval = setInterval(timerIncrement, 80); //Increment the idle time counter every 10ms.
