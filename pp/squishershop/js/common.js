...
function pageScript() {
  ...
  $(document).ready(function () {
    ...
    //home page section
    if ($(".full_slider_sec").length && isDekstop) {
    ...
    function afterPageLoad() {
      ...
      if ($(".all_details_fig").length) {
        ...
        img_tl = isDekstop ? img_tl.timeScale(1) : img_tl.timeScale(9);
        ScrollTrigger.create({
          trigger: ".all_details_fig",
          start: isDekstop ? "top top" : "top center",
          scrub: isDekstop ? 1.3 : false,
          end: "+=50%",
          pin: isDekstop ? true : false,
          animation: img_tl,
      ...
      if ($(".dtl_table").length) {
        ...
        table_tl = isDekstop ? table_tl.timeScale(1) : table_tl.timeScale(9);
        ScrollTrigger.create({
          trigger: ".dtl_table",
          start: isDekstop ? "top 80%" : "top center",
          scrub: isDekstop ? 1.3 : false,
          end: "+=60%",
          animation: table_tl,
          invalidateOnRefresh: true,
