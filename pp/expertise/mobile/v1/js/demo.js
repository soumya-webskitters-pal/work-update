...
MODEL = function () {
  ...
  MODEL.prototype.moveHandle = function (event) {
    ...
    //       // console.log(figures)
    //       // FAR = shapeWidth * 2.5;
    //       // new TweenMax.to(figures.scale, 1, {
    //       //   x: 1,
    //       //   y: 1,
    //       //   z: 1,
    //       //   onUpdate: () => {
    //       //     new TweenMax.to(figures.position, 1, {
    //       //       x: 0,
    //       //       y: 0,
    //       //       z: 0,
    //       //       // onUpdate: () => {
    //       //       //   new TweenMax.to(figures.material.color, 0.2, {
    //       //       //     r: hoverInitial.r,
    //       //       //     g: hoverInitial.g,
    //       //       //     b: hoverInitial.b,
    //       //       //   });
