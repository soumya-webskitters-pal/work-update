...
MODEL = function () {
    ...
    MODEL.prototype.ClickHandle = function (event) {
        ...
        document.querySelector("#sl_nxt").onclick = function () {
            console.log("click")
        ...
        document.querySelector("#sl_prev").onclick = function () {
            console.log("click")
            if ((focus_node - 1) > 0) {
                focus_node--;
                smoothScroll = true;
...
window.onload = function () {
    ...
    if (WEBGL.isWebGLAvailable()) {
        ...
        //     console.log(_description.offsetHeight>=window.innerHeight - );
        //     //if (_dataBox.height >= (window.innerHeight - ))
        //     // if (aaaa) {
        //     //     descriptionId.niceScroll();
        //     //     descriptionId.niceScroll("div.nice-wrapper", {
        //     //         cursorwidth: "8px"
        //     //     });
        //     // } else {}
        // }
