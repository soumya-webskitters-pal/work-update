...
MODEL = function () {
    ...
    MODEL.prototype.SceneLoad = function () {
        ...
        for (var i = 0; i < canvasWidth; i++) {
            ...
            // var qq = new TweenMax.to(triMeshClone.rotation, 50, {
            //     repeat: -1,
            //     paused: false,
            //     delay: 0,
            //     yoyo: true,
    ...
    MODEL.prototype.Animate = function () {
        ...
        //click
        if (autoScroll) {
            // var ww = new TweenMax.to(container, 0.5, {
            //     repeat: -1,
            //     ease: Power2.easeOut,
            //     onUpdate: () => {
            //         var scrollSpeed = cameraMoveOffset;
    ...
    MODEL.prototype.Scroll = function (event) {
        ...
        const _wheelUP = function () {
            if (event.deltaY > 0) {
                ...
                //     onUpdate: () => {
                //         cameraSpeed--;
                //         scrollSpeed = event.deltaY * cameraSpeed / 100000;
                //         if (scrollSpeed > 0.009) {
                //             scrollSpeed = scrollSpeed / cameraSpeed
                //         }
                //         else if (scrollSpeed < 0.0009) {
