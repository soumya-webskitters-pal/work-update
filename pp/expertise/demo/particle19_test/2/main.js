...
var buttonDisableTime = 1000;

////for animated mesh
var r = 20, rHalf = r / 2;
var maxParticleCount = 1000;
var particleCount = maxParticleCount - r;
...
const effectController = {
    ...
    maxConnections: maxParticleCount,
...
MODEL = function () {
    ...
    MODEL.prototype.SceneLoad = function () {
        ...
        curve = (function () {
            ...
            return {
                getPointAt: function (t) {
                    ...
                    var z = b * t * 5;
                    if (group.children.length < (((actualElCount - 1) * 2) * (actualElCount - 1))) {
                        var pointMesh1 = linesMesh.clone();
                        pointMesh1.position.x = x / 2;
                        pointMesh1.position.y = y / 2;
                        pointMesh1.position.z = z / 2;
                        group.add(pointMesh1);
                        var pointcloud1 = pointCloud.clone();
                        pointcloud1.position.x = x / 2;
                        pointcloud1.position.y = y / 2;
                        pointcloud1.position.z = z / 2;
                        group.add(pointcloud1);
                        console.log(group)
                    }
        ...
        var geometry = new RollerCoasterGeometry(curve, 500); //give low faces because We hide the RollerCoasterGeometry. 
        ...
        for (var t = 0; t < 50; t++) {
            ...
            triMeshClone.material.opacity = Math.random() * 10;
