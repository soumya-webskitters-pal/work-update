...
MODEL = function () {
    ...
    MODEL.prototype.Animate = function () {
        ...
        if (autoScroll) {
            ...
            var sec_calculation = (progress * 100) / (0.625);
    ...
    MODEL.prototype.selectedNode = function () {
        ...
        // var mkTween = TweenMax.fromTo(DataMesh[focus_node].material.color, 0.9,
        //     {
        //         r: hoverValue.r,
        //         g: hoverValue.g,
        //         b: hoverValue.b,
        ...
        //         g: hoverInitial.g,
        //         b: hoverInitial.b,
        //         repeat: -1, /* infinite amount of repeats */
        //         onUpdate: function () {
        //             var kkk = TweenMax.to(DataMesh[focus_node].scale, 1,
        //                 {
        //                     x: 1.5,
        //                     y: 1.5,
        //                     z: 1.5
    ...
    MODEL.prototype.openModal = function (node_data) {
        ...
        if (node_data.content.name !== null) {
            ...
            // var nowAvailableHeight = nowWindowHeight - 50;
            // var NowDataBoxHeight = _dataBox.clientHeight;
            // if (NowDataBoxHeight >= nowAvailableHeight) {
            //     var dataBoxHeight = nowAvailableHeight - 50;
            //     _dataBox.style.maxHeight = dataBoxHeight;
            //     _description.parentNode.style.maxHeight = dataBoxHeight - 100;
            //     var nice_bar = jQuery(".node_text");
            //     nice_bar.niceScroll();
            //     nice_bar.niceScroll("div.nice-wrapper", {
            //         cursorwidth: "8px"
            //     });
            //     jQuery(".node_text").getNiceScroll().resize();
            // }
            // else {
            //     _dataBox.style.maxHeight = "unset";
            //     _description.parentNode.style.maxHeight = "unset";
            // }
            //end--height set
