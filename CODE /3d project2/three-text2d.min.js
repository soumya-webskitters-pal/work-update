        ...
        h = (function (t) {
          function e(e, i) {
            ...
            return (
              ...
              (n._lineHeight = i.lineHeight || 1.2),
            ...
            (e.prototype.updateAlign = function () {
              this.sprite &&
                ((this.sprite.center.x =
                  ((0.5 - 0.5 * this._align.x) * this.canvas.textWidth) /
                  this.canvas.width),
                (this.sprite.center.y =
                  1 -
                  ((0.5 * this._align.y + 0.5) * this.canvas.textHeight) /
                    this.canvas.height));
            }),
            Object.defineProperty(e.prototype, "align", {
              get: function () {
          ...
          return (
            ...
            (t.prototype.drawText = function (t, e) {
              ...
              (this.textWidth = Math.max.apply(
                ...
                (this.textHeight = s + s * e.lineHeight * (o.length - 1)),
                (this.canvas.width = Math.max(
                  2,
                  n.Math.ceilPowerOfTwo(this.textWidth)
                )),
                (this.canvas.height = Math.max(
                  2,
                  n.Math.ceilPowerOfTwo(this.textHeight)
                )),
                (this.ctx.font = e.font),
              ...
              for (
                var a = this.textWidth * (0.5 - 0.5 * e.align.x), h = 0;
                h < o.length;
                h++
              )
                this.ctx.fillText(o[h], a, s * e.lineHeight * h);
              return this.canvas;
            }),
            t
          );
